  ...
  return (
    <Layout pageTitle="About Me">
      ...
      <p>
        ...
        experience for this blog. The blog posts are generated using markdown
        and a template to render them.
      </p>
      <p>
        I'm a full-stack developer from London, UK working with the Microsoft
        platform on SharePoint. At work I use the following stack:
      </p>
      <ul>
        <li>React + TS</li>
        <li>CSS / Sass</li>
